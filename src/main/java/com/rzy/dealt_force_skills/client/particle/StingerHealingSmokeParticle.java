...
/** Single static large green smoke billboard for enhanced Stinger smoke. */
public class StingerHealingSmokeParticle extends TextureSheetParticle {
    private final SpriteSet sprites;
    private final float baseSize;

    public StingerHealingSmokeParticle(ClientLevel level, double x, double y, double z,
        ...
        this.alpha = 0.90F;
        // Phase 811 was ~5.5–6.3; enlarge +200% (x3) for FOV occlusion, still one particle.
        this.baseSize = 16.5F + random.nextFloat() * 2.4F;
        this.quadSize = this.baseSize;
        this.setColor(0.26F + random.nextFloat() * 0.10F,
                0.92F + random.nextFloat() * 0.08F,
                0.42F + random.nextFloat() * 0.10F);
