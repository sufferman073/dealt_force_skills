...
public final class LunaPlaceholderVisuals {
    ...
    public static void onRenderHand(RenderHandEvent event) {
        ...
        poseStack.pushPose();
        if (ClientLunaHudState.equippedTool() == LunaTool.COMPOSITE_GRENADE) {
    ...
    private static ItemStack placeholderStack() {
        return switch (ClientLunaHudState.equippedTool()) {
            case SHOCK_BOW, RECON_BOW -> new ItemStack(Items.BOW);
            case COMPOSITE_GRENADE -> new ItemStack(Items.IRON_NUGGET);
