...
public final class GizmoPlacementHelper {
    public static volatile double SMOKE_RANGE = com.rzy.dealt_force_skills.config.DealtForceConfig.bind("SMOKE_RANGE", () -> com.rzy.dealt_force_skills.config.DealtForceConfig.doubleValue("characters.gizmo.gizmo_placement_helper.smoke_range", 5.0));
    public static volatile double SPIDER_RANGE = com.rzy.dealt_force_skills.config.DealtForceConfig.bind("SPIDER_RANGE", () -> com.rzy.dealt_force_skills.config.DealtForceConfig.doubleValue("characters.gizmo.gizmo_placement_helper.spider_range", 3.5));
